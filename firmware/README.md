...
| Sketch | Board (FQBN) | Role |
|--------|--------------|------|
| `k10_percept/` | `esp32:esp32:esp32s3` | UNIHIKER K10 percept leaf (Phase 1) |
| `v4a_bridge/`  | `esp32:esp32:esp32s3` | Heltec V4 bridge / head |
| `v4b_relay/`   | `esp32:esp32:esp32s3` | Heltec V4 relay / mid |
| `v4c_edge/`    | `esp32:esp32:esp32s3` | Heltec V4 edge / tail |
