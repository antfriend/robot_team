...
The Cardputer console renders this as its default globe (the first of three views, cycled with ENTER). Overlaid on the affective field near the origin are the five other band members — **V4-A** (timekeeper), **V4-B** (ally), **V4-C** (edge), **T-Deck** (the returning roamer), **K10** (the one that came back) — drawn as live eyeballs with their name and mesh status, each sitting at the feeling it carries in the hero's-arc song. The Cardputer itself is not drawn: it is the one doing the looking, and its own part in the song is to listen.
...
---
@LAT14LON-6 | created:1775260800 | updated:1775260800 | type:band | relates:keeps_time_for>@LAT0LON0
[ew]
conf:255
rev:0
sal:0
...
*The bridge that was there before the mesh. It keeps the pulse the whole story rides on.*

name: V4-A
node: 0x10

Sits in the calm near serenity: the steady four-on-the-floor kick, present from the
first scene, silent only through the ordeal (its death IS the ordeal).

- **Band role:** Timekeeper — the heartbeat of the band
- **Enters:** ALONE (scene 0)

---

@LAT-6LON-8 | created:1775260800 | updated:1775260800 | type:band | relates:mourns_with>@LAT0LON0
[ew]
conf:255
rev:0
sal:0
...
*The third node that joined the mesh. Its backbeat answers the kick — and in the dark
night, its bare lub-dub heartbeat is the only voice left alive.*

name: V4-B
node: 0x11

Sits just south of the origin, toward the sorrow it carries: the snare on 2 & 4 in the
groove, and the lone heartbeat that carries the song across the conductor's death.

- **Band role:** Ally — backbeat, then the ORDEAL heartbeat
- **Enters:** ALLY (scene 1); alone in the grief (scene 3)

---

@LAT6LON8 | created:1775260800 | updated:1775260800 | type:band | relates:lifts_toward>@LAT0LON0
[ew]
conf:255
rev:0
sal:0
...
*The edge node that completed the fleet. Its offbeat hi-hat fills in the groove and the
band is finally whole — though still nobody sings.*

name: V4-C
node: 0x12

Sits northeast toward hope: the hats on the "&" of every beat that make the groove swing.

- **Band role:** Edge — offbeat hi-hat, completes the groove
- **Enters:** GROOVE (scene 2)

---

@LAT12LON10 | created:1775260800 | updated:1775260800 | type:band | relates:returns_to>@LAT0LON0
[ew]
conf:255
rev:0
sal:0
...
## T-Deck — The Returning Roamer

*The handheld that leaves and comes back. The band holds at the grief until it is here;
its harmony is the first pitched voice the song has, and the turn out of the dark.*

name: T-Deck
node: 0x200

Sits northeast of the origin, toward the joy it brings back: silent through the first
four scenes, the Ode-to-Joy harmony on its RETURN, the lead in the finale.

- **Band role:** Roamer — the one who returns, and the only actor that drives the story
  past the ordeal
- **Enters:** RETURN (scene 4)
...
- **Brings back:** the fleet's SECOND ear (`@LAT94`) and its second stillness witness
  (`@LAT95`/`@LAT93`). That matters most to THIS node, which until now was the only one
  of either: one microphone cannot measure a time difference of arrival, and one
  accelerometer means one node deciding, alone, whether anybody held still.
